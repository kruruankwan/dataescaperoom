...
if st.session_state.stage == 0:
    ...
    <div class="game-card">
        ...
        <ul>
            ...
            <li>-กรุณากรอก “ชื่อกลุ่ม” และ “ห้องเรียน” ให้ครบก่อนเริ่มเกม </li>
            <li>-เมื่อเริ่มเกมระบบจะจับเวลาอัตโนมัติและบันทึกผลเพื่อแสดงใน Leaderboard </li>
            <li>-วิธีทำแต่ละด่าน ให้อ่านโจทย์ → ดาวน์โหลดไฟล์ CSV แต่ละด่าน → และเขียนโปรแกรมใน Google Colaboratory  →  </li>
            <li>-นำคำตอบที่ได้มากรอก “คำตอบ” ลงช่องของแต่ละด่าน → และกดตรวจคำตอบเพื่อไปยังด่านถัดไป</li>
            <li>-หลังจบเกมแต่ละด่านให้บันทึกคำตอบและคำสั่งที่ใช้ลงใบงาน </li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
