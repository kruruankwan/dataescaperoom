...
HINTS = {
    ...
    4: "ใบ้: ดูคอลัมน์ <b>Visitors</b> แล้วหา “หาผลรวม” (sum).",
...
if st.session_state.stage == 0:
    ...
    <div class="game-card">
        <h3>🎮 คำชี้แจง </h3>
        <ul>
            <li>กิจกรรมนี้เป็นเกม “Data Escape Room” ฝึกวิเคราะห์ข้อมูลจากไฟล์ CSV จำนวน 5 ด่าน</li>
            <li>โดยใช้ Python (Pandas) เพื่อหาคำตอบและถอดรหัส เมื่อกรอกคำตอบถูกต้องจะได้รับเหรียญและปลดล็อกด่านถัดไป</li>
            <li>-ให้สมาชิกแบ่งบทบาทตามที่ระบุ (ในใบงาน)</li>
            <li>-กรุณากรอก “ชื่อกลุ่ม” (นำมาจากใบงาน) และ “ห้องเรียน” ให้ครบก่อนเริ่มเกม (ในใบงาน)</li>
            <li>-เมื่อเริ่มเกมระบบจะจับเวลาอัตโนมัติและบันทึกผลเพื่อแสดงใน Leaderboard(ในใบงาน)</li>
            <li>-วิธีทำแต่ละด่าน ให้อ่านโจทย์ → ดาวน์โหลดไฟล์ CSV แต่ละด่าน → อัปโหลดไฟล์ CSV และเขียนโปรแกรมใน Google Colaboratory  → ใช้ Pandas วิเคราะห์  </li>
            <li>-นำคำตอบที่ได้มากรอก “คำตอบ” ลงช่องของแต่ละด่าน → แลพกดตรวจคำตอบเพื่อไปยังด่านถัดไป</li>
            <li>-หลังจบเกมแต่ละด่านให้บันทึกคำตอบและคำสั่งที่ใช้ลงใบงาน และร่วมสะท้อนผลการเรียนรู้กับเพื่อนในกลุ่ม(ในใบงาน)</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
...
# -------------------------------------------------
    ...
    stage_card(
        ...
        "<b>ภารกิจ:</b> เปิดไฟล์ CSV แล้วหาค่า <b>ยอดขาย</b> ที่มากที่สุด",
        "stage1.png"
    )
    hint_block(1)
...
# -------------------------------------------------
    ...
    stage_card(
        ...
        "<b>ภารกิจ:</b> เปิดไฟล์ CSV แล้วหาค่า <b>จำนวนนาทีออกกำลังกาย</b> ที่น้อยที่สุด",
        "stage2.png"
    )
    hint_block(2)
...
# -------------------------------------------------
    ...
    stage_card(
        ...
        "<b>ภารกิจ:</b> เปิดไฟล์ CSV แล้วหาค่า <b>การใช้หน่วยไฟฟ้า</b> ที่มากที่สุด",
        "stage3.png"
    )
    hint_block(3)
...
# -------------------------------------------------
    ...
    stage_card(
        ...
        "<b>ภารกิจ:</b> เปิดไฟล์ CSV แล้วหาค่าผลรวมของผู้เยี่ยมชมเว็บไซต์ทั้งหมด",
        "stage4.png"
    )
    hint_block(4)
...
# -------------------------------------------------
    ...
    stage_card(
        ...
        "<b>ภารกิจ:</b> หา <b>ค่าเฉลี่ยชั่วโมงที่ใช้งาน Wi-Fi</b> เป็นทศนิยม 2 ตำแหน่ง",
        "stage5.png"
    )
    hint_block(5)
